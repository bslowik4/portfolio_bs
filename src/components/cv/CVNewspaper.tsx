  ...
  const employment = [
    {
      ...
      endDate: 'Present',
      description: [
        'Developed and delivered custom web solutions for various client projects',
        'Collaborated closely with clients to gather requirements and translate them into functional applications',
        'Contributed to small, agile teams, ensuring smooth communication and efficient project delivery',
    ...
    },
    {
      ...
      endDate: 'Present',
      description: [
        'Developed a full-stack web application enabling users to create personalized mini websites',
        'Implemented security and privacy best practices to protect user data',
        'Deployed and maintained the application using AWS cloud services',
        'Currently developing a system for automatic video generation from dynamic content, integrating AI-based processing',
      ],
    },
    {
      position: 'Fullstack Developer',
      company: 'KNP Pragma UJ',
      location: 'Kraków, Poland',
      startDate: 'April 2025',
      endDate: 'Present',
      description: [
        'Contributed to the development of a data collection platform for research purposes',
        'Developed a full-stack web application using React (frontend) and Express.js (backend), implementing RESTful APIs and optimized state management for performance and scalability',
        'Deployed, hosted, and maintained the application on Microsoft Azure Cloud Services',
        'Assisted in resolving user issues and improving overall code quality and stability',
        'Designed and implemented automated email workflows for user communication and notifications',
      ],
    },
    {
      position: 'Team Lead',
      company: 'Solana marketplace - Undisclosed Client',
      location: 'Kraków, Poland',
      ...
      description: [
        ...
        'Collaborated with client to define features, timelines, and product roadmap priorities',
      ],
    },
    {
      ...
      description: [
        'Developed and optimized Python algorithms for data processing and analysis',
        'Conducted comparative evaluations of machine learning libraries to improve model performance and accuracy',
        'Presented findings and insights to the data science team, supporting data-driven decision-making',
      ],
    },
    {
      ...
      endDate: 'Feb 2021',
      description: [
        'Designed and developed a modern, responsive e-commerce website focused on usability and performance',
        'Utilized the company’s CMS platform to manage products, content, and visual layouts',
        'Created and maintained technical documentation and managed the project repository for team collaboration',
      ],
    },
  ];
